...
@Component({
  ...
  templateUrl: './bac-layout.component.html',
  styleUrl: './bac-layout.component.css',
  animations: [
...
export class BacLayoutComponent implements OnInit, OnDestroy {
