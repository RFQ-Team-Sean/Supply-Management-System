...
@Component({
  selector: 'app-receive-document-proceed',
  standalone: true,
  imports: [CommonModule, QRCodeModule, FormsModule],
  templateUrl: './receive-document-proceed.component.html',
  styleUrls: ['./receive-document-proceed.component.css']
})
export class ReceiveDocumentProceedComponent implements OnInit {
